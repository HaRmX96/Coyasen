...
func (this *Admin) Handle() {
    ...
    this.conn.Write([]byte("\x1b[0m     \x1b[1;34mVersion XVI | Discord : HaRmX96#8916 | Github : HaRmX96 | Email : HaRmX96@proton.me\x1b[0m\r\n"))
    this.conn.Write([]byte("\x1b[0m\x1b[1;94m\x1b[0m\r\n"))
    this.conn.Write([]byte("\x1b[0m\x1b[1;94m\x1b[0m\r\n"))
    this.conn.Write([]byte("\x1b[0m                             \x1b[1;94m╔═╗ ╔═╗ ╗ ╔ ╔═╗ ╔═╗ ╔═╗ ╔╗╔\x1b[0m\r\n"))    
    this.conn.Write([]byte("\x1b[0m                             \x1b[1;94m║   ║ ║ ╚╔╝ ║═║ ╚═╗ ║╣  ║║║\x1b[0m\r\n"))    
    this.conn.Write([]byte("\x1b[0m                             \x1b[1;94m╚═╝ ╚═╝ ═╝═ ╝ ╚ ╚═╝ ╚═╝ ╝╚╝ XVI\x1b[0m\r\n"))    
    this.conn.Write([]byte("\x1b[34m                                      😈 𝕯𝖎𝖘𝖗𝖊𝖘𝖕𝖊𝖈𝖙 = 𝕯𝖎𝖘𝖈𝖔𝖓𝖓𝖊𝖈𝖙 😈\r\n"))
    this.conn.Write([]byte("\x1b[34m                                  ══╦═════════════════════════════╦══\r\n"))
    this.conn.Write([]byte("\x1b[34m                           ╔════════╩═════════════════════════════╩═════════╗\r\n"))
    this.conn.Write([]byte("\x1b[34m                           ║ Welcome to the start screen of  Coyasen Botnet ║\r\n"))
    this.conn.Write([]byte("\x1b[94m                           ║     Powered by CoyasenAPI , Ran by [@harmxvu]  ║\r\n"))
    this.conn.Write([]byte("\x1b[94m                        ╔╗ ╚════════════════════════════════════════════════╝ ╔╗\r\n"))
    this.conn.Write([]byte("\x1b[94m                        ║╚════════════════════════════════════════════════════╝║\r\n"))
    this.conn.Write([]byte("\x1b[94m                        ║         Type 'help' or '?' to show the command       ║\r\n"))
    this.conn.Write([]byte("\x1b[94m                        ║      Copyright © 2023 Coyasen All Rights Reserved    ║\r\n"))
    this.conn.Write([]byte("\x1b[94m                        ╚══════════════════════════════════════════════════════╝\r\n"))
    ...
    for {
        ...
        var botCount int
        this.conn.Write([]byte("\x1b[1;37m" + username + "\x1b[0;36m@\x1b[1;37mCoyasen \x1b[1;37m~ \x1b[0;36m$ \033[0m"))
